...
-- "relation" in errors means "table"
-- INSERT is CREATE
--SELECT is READ
...
INSERT INTO "songs"("id", "rank", "artist", "track", "published") VALUES(214, 466, 'The Scissor Sisters', 'I Don''t Feel Like Dancin''', '1/1/2006') RETURNING "id", "rank", "artist", "track", "published";
...
SELECT * FROM "songs"
WHERE "track" = 'Wonderwall';

SELECT * FROM "songs"
WHERE "artist" = 'Elvis Presley';

SELECT * FROM "songs"
WHERE "track" LIKE '%You%'
AND "artist" = 'Elvis Presley';
...
SELECT "track", "artist", "published" FROM "songs" WHERE "published" >= '1-1-2001'
